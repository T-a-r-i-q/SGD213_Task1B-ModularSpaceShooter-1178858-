...
public class PlayerInput : MonoBehaviour {
    ...
    // local references
    private EngineMovement playerMovement;
    ...
    //Initialization of our local references
    void Start() {

        playerMovement = GetComponent<EngineMovement>();
        weapon = GetComponent<WeaponBase>();
    }

    //Apply player input to our local references to perform the appropriate actions based on the input received.
    void Update() {
    ...
    /// </summary>
    /// <param name="weaponType"> The given weaponType to swap our current weapon to, this is an enum in 
    /// WeaponBase.cs </param>
